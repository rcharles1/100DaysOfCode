...
/* 
    Day 65 of 100 Days of Code 
      Redux Middleware and Thunkcs
        1. Middleware in Redux
                - generally a code that runs in the middle. Usually btn a framework receiving requests and returning responses.
                In Redux, middleware runs btn when actions are dispatched and before being passed to reducers in the store.
                ...
                b. Thunks 
                   A high-order function that wraps the computation intended to be performed later.

                c. Promise LifeCycle Actions
                        need to show pending, fulfilled and rejected states of a asynchronous logic in Redux. 
                        achieved by createAsyncThunk

                        i. createAsyncThunk()
                           import { createAsyncThunk } from 'reduxjs/toolkit
                           takes 2 params;  action type: recipes/searchRecipesByName
                                             async function: takes arg-corresponds to first argument passed to thunk aciton creator itself;
                                              and thunkAPI -contains methods such as dispatch, getState as params
                        ...
                        ii. Actions Generated by createAsyncThunk
                            - basing on action type provided, the following are generated
                                'users/fetchUserById/pending'
                                'users/fetchUserById/fulfilled'
                                'users/fetchUserById/rejected'

                             - can be individually accessed as follows;
                                fetchUserById.pending
                                fetchUserById.fulfilled
                                fetchUserById.rejected

                d. createSlice() with Async Action Creators
                    use of extraReducers optionally pass property to createSlice to respond to action types it did not generate.
                    Syntax
